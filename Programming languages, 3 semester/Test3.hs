...
test_nat_3 = take 5 (drop 100 nat) == [101, 102, 103, 104, 105]
test_nat_4 = take 5 (drop 1 nat) == [2, 3, 4, 5, 6]

------  Задание 2 fibonacci 
test_fibonacci_1 = take 8 fibonacci == [0,1,1,2,3,5,8,13]
test_fibonacci_2 = take 3 (drop 1 fibonacci) == [1,1,2]
test_fibonacci_3 = take 2 fibonacci == [0,1]

------ Задание 3 factorial 
test_factorial_1 = take 5 factorial == [1,1,2,6,24]
test_factorial_2 = take 1 factorial == [1] 
test_factorial_3 = take 4 (drop 1 factorial) == [1,2,6,24] 
...
test_powerSeq_3 = take 5 (powerSeq 3) == [1,3,9,27,81]
test_powerSeq_4 = take 5 (powerSeq 10) == [1,10,100,1000,10000]
...
test_derivativeAppr_1 = abs (derivativeAppr sin epsilon'' x - cos x) < epsilon
  where x = pi
test_derivativeAppr_2 = derivativeAppr cos epsilon'' x == 0
  where x = pi
...
main = do 
  ...
  putStrLn ("4 test_powerSeq_4 " ++ (show test_powerSeq_4))
  ...
  putStrLn ("10 test_derivativeAppr_2 " ++ (show test_derivativeAppr_2))
